...
namespace P40f_Menu_Dinamico
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string[] vMenu = { "PORTÓN POLIMORFISMOoooooooooooooooooooooooooooooooooooooooooooo", "Abrir Todos Los Portones Que Quieres", "Cerrar", "Bloquear", "Desbloquear", "Pintar", "Fabricar", "Eliminar", "Modificar", "Mostrar" };
            Menu m1 = new Menu(vMenu);
        ...
        public static Puerta SeleccionarPuerta_o_Porton(List<Puerta> listaPuertasPortones) // devuelve un objeto del tipo Puerta pero creado como Porton (polimorfismo)
        {
            ...
            do
            {
                ...
                if (!nombreOk) Tools.Error_Pro("Ningún nombre de la lista coincide con el introducido", 24, 5);
        ...
        public static void BloquearUnaBloquearTodas(int opcion, List<Puerta> listaPuertasPortones)
        {
            ...
            else
            {
                for (int i = 0; i < listaPuertasPortones.Count; i++)
                {
                    ...
                    {
                        Tools.Error_Pro("Los objetos de tipo Puerta no se pueden bloquear, tan sólo los de tipo Porton pueden bloquearse", 24, 5);
                    }
                }   
            }
        }
