...
namespace P41b4_Paralelogramos_Clase_Abstracta
{
    class Program
    {
        ...
        {
            List<Paralelogramo> figureList = new List<Paralelogramo>();
            int option = 0;
            ...
            do
            {
                ...
                switch (option)
                {
                    ...
                    case 1:
                        figureList.Add
                        (
                            new Cuadrado(SetFigureName(vNombres[option], vContadores[option]), ladoBaseFigura)
                        );
                        break;
                    ...
                    case 2:
                        ...
                        figureList.Add
                        (
                            new Rectangulo(SetFigureName(vNombres[option], vContadores[option]), ladoBaseFigura, ladoLateralFigura)
                        );
                        break;
        ...
        static void ShowFiguresFeatures(List<Paralelogramo> figureList)
        {
            Console.WriteLine("\n\n\tNombre          Base    Lateral   Ángulo    Perim.    Área");
            Console.WriteLine("\t----------------------------------------------------------------------\n");

            foreach (Paralelogramo figura in figureList)
