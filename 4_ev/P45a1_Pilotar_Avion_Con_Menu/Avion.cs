...
namespace P45a1_Pilotar_Avion_Con_Menu
{
    class Avion
    {
        ...
        public int AltitudMax { get => altitudMax; }
        public int VelocidadMax { get => velocidadMax; }
        ...
        public bool EnVuelo { get => enVuelo; }
        ...
        public void DisminuirVelocidad(int descenso)
        {
            int total = 0;
        ...
        public void AumentarAltitud(int aumento)
        {
            int total = 0;
        ...
        public void DisminuirAltitud(int descenso)
        {
            int total = 0;
        ...
        public void Despegar()
        {
            if (!enVuelo)
            {
                if (velocidad >= 200)
                {
                    ...
                    Console.WriteLine("\n\n\tAcabamos de despegar, y hemos alcanzado una altura de " + altitud + "m");
                }
        ...
        public void Aterrizar()
        {
            if (enVuelo)
            {
                if (velocidad < 400 && altitud < 200)
                {
                    ...
                    Console.WriteLine("\n\n\tAcabamos de aterrizar, gracias por elegir " + marca);
                }
        ...
        public override string ToString()
        {
            ...
            (
                ...
                Tools.CuadraTexto(modelo, 14),
                Tools.CuadraTexto(matricula, 17),
                Tools.CuadraTexto(altitud.ToString() + " m", 15),
                Tools.CuadraTexto(altitudMax.ToString() + " m", 18),
                Tools.CuadraTexto(velocidad.ToString() + " km/h", 17),
