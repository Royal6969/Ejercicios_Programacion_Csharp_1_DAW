...
namespace P43a2_Proyecto_Portón_Con_Herencia
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Porton porton1 = new Porton("porton-base1", 150, 130, ConsoleColor.White);
            Porton porton2 = new Porton("porton-base2", 200, 180, ConsoleColor.White);
            Porton porton3 = new Porton("porton-base3", 225, 195, ConsoleColor.White);
            Porton porton4 = new Porton("porton-base4", 250, 115, ConsoleColor.White);
