...
namespace P45b_Tripulacion
{
    class Tools
    {
        ...
        public static void ShowMenu2()
        {
            ...
            Console.WriteLine("\t\t\t║ Opciones del Piloto        ║");
            Console.WriteLine("\t\t\t╠════════════════════════════╣");
            Console.WriteLine("\t\t\t║ 1) Ayudar a subir Heridos  ║");
            Console.WriteLine("\t\t\t║ 2) Pasar Lista de Heridos  ║");
            Console.WriteLine("\t\t\t║ 3) Aumentar Velocidad      ║");
            Console.WriteLine("\t\t\t║ 4) Disminuir Velocidad     ║");
            Console.WriteLine("\t\t\t║ 5) Despegar                ║");
            Console.WriteLine("\t\t\t║ 6) Aumentar Altitud        ║");
            Console.WriteLine("\t\t\t║ 7) Disminuir Altitud       ║");
            Console.WriteLine("\t\t\t║ 8) Aterrizar               ║");
            Console.WriteLine("\t\t\t║                            ║");
            Console.WriteLine("\t\t\t║ 0) Salir                   ║");
            Console.WriteLine("\t\t\t╚════════════════════════════╝");
        }
