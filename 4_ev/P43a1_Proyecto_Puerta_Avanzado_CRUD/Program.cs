...
namespace P43a1_Proyecto_Puerta_Avanzado_CRUD
{
    class Program
    {
        public static Puerta puerta = new Puerta("p-base", 100, 80, ConsoleColor.White);
        ...
        public static void EliminarPuerta(List<Puerta> listaPuertas)
        {
            ...
            for (int i = 1; i < listaPuertas.Count; i++)
            {
            ...
            if (puerta.Nombre == "p-base") Console.WriteLine("\n\n\tNo puedes eliminar la p-base y dejar la lista vacía");
