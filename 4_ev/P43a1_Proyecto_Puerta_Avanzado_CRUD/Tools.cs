...
namespace P43a1_Proyecto_Puerta_Avanzado_CRUD
{
    class Tools
    {
        ...
        public static void ShowMenu()
        {
            Console.WriteLine("\n\n\n\n");
            Console.WriteLine("\t\t\t╔═════════════════════╗");
            Console.WriteLine("\t\t\t║   CRUD de PUERTA    ║");
            Console.WriteLine("\t\t\t╠═════════════════════╣");
        ...
        {
            ConsoleColor[] vColores = { ConsoleColor.Gray, ConsoleColor.DarkBlue, ConsoleColor.Green, ConsoleColor.Cyan, ConsoleColor.Red, ConsoleColor.Magenta, ConsoleColor.Yellow, ConsoleColor.White };
