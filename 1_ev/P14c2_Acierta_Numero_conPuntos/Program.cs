...
namespace P14c2_Acierta_Numero_conPuntos
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Para ello, cuenta con tres oportunidades y con 100 puntos para intentarlo");
            Console.WriteLine("Si falla, se restará una oportunidad y se restarán 40 puntos ... si pierde las tres oportunidades, se restarán 20 puntos.");
            ...
            do
            {
                ...
                else if (respuesta == num && oportunidades == 3)
                {
                    puntos += 100;
                    Console.WriteLine("Acertaste en el " + oportunidades + "º intento ... por lo que obtienes "+puntos+" puntos !!");
                }
                else
                {
                    ...
                    Console.WriteLine("Le quedan " + oportunidades + " oportunidades y " + puntos + " (-40) puntos.");
                }
                ...
                if (oportunidades == 0)
                {
                    ...
                    puntos += 20;
                    Thread.Sleep(1500);
                    Console.WriteLine("Puntos: "+puntos+" - 20 = "+(puntos-20));
                    Console.WriteLine("\nHas agotado las tres oportunidades ... Has perdido con "+puntos+" puntos");
